...
// SBF: define{{.*}} void @ParamPassing3(i15 signext %{{.+}}, i31 signext %{{.+}})
...
// SBF: define{{.*}} i128 @ReturnPassing4(
...
// BPF-NOT: define{{.*}} void @ReturnPassing5(ptr dead_on_unwind noalias writable sret
// SBF-NOT: define{{.*}} void @ReturnPassing5(ptr dead_on_unwind noalias writable sret
